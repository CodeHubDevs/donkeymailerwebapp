...
const SelectCard: React.FC<SelectCardProps> = ({
  ...
  return (
    <div className='flex flex-col items-center gap-4 rounded-2xl bg-black5 p-8'>
      ...
      <p className='text-center text-sm text-black50'>{description}</p>
      <div className='mr-24 ml-24 flex flex-col items-start bg-black5 text-sm'>
        <p className='text-black50'>{detailOne}</p>
        <p className='text-black50'>{detailTwo}</p>
      </div>
